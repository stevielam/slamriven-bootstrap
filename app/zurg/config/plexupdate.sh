...
token="plex_token_here" # open Plex in a browser, open dev console and copy-paste this: window.localStorage.getItem("myPlexAccessToken")
zurg_mount="/zurg" # replace with your zurg mount path, ensure this is what Plex sees
